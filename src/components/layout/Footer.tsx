...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-[#030303] overflow-hidden pt-16 pb-12">
      ...
      <div className="container mx-auto px-6 md:px-12 flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="text-center md:text-left">
          <p className="text-lg font-bold font-display text-white">R.J. Hariharan</p>
          ...
          {socialLinks.map((social) => {
            ...
            return (
              <motion.a 
                ...
                whileTap={{ scale: 0.95 }}
                className="w-10 h-10 rounded-full bg-white/5 border border-white/5 flex items-center justify-center text-secondary hover:text-accent-blue hover:bg-white/10 hover:border-accent-blue/30 transition-colors duration-300"
              >
                <Icon size={18} />
              </motion.a>
            );
